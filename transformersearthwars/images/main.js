$(document).ready(function() {	
	...
	var select = $( "#Cyber Coins-amount-wrapper" );
	var slider = $( "<div id='slider-Cyber Coins'></div>" ).insertAfter( select ).slider({
		min: 100000,
		max: 999999,
		value: 100000,
		range: "min",
		change: function(event, ui) { 
			var sliderValue = $( "#slider-Cyber Coins" ).slider( "option", "value" );				
			$('#Cyber Coins-amount').html(sliderValue);
			if(sliderValue == '100000') {
				progressBar(20, $('#progressBar'));
				$('#decrease-Cyber Coins').addClass('btn-disabled');
				$('.max-amount-Cyber Coins').fadeOut();
			}
			else if (sliderValue == '250000') {
				progressBar(40, $('#progressBar'));
				$('#decrease-Cyber Coins').removeClass('btn-disabled');
			}
				...
				$('#increase-Cyber Coins').removeClass('btn-disabled');
				$('.max-amount-Cyber Coins').fadeOut();
			}
			else if (sliderValue == '999999') {
				progressBar(100, $('#progressBar'));
				$('#increase-Cyber Coins').addClass('btn-disabled');
				$('.max-amount-Cyber Coins').fadeIn();
			}
		}        
	});	
	
	$('#increase-Cyber Coins').click(function() {
	var sliderCurrentValue = $( "#slider-Cyber Coins" ).slider( "option", "value" );
	  slider.slider( "value", sliderCurrentValue + 150000 );
	});

	$('#decrease-Cyber Coins').click(function() {
	var sliderCurrentValue = $( "#slider-Cyber Coins" ).slider( "option", "value" );
	  slider.slider( "value", sliderCurrentValue - 150000 );
	});

	function progressBarCyber Coins(percent, $element) {
		var progressBarCyber CoinsWidth = percent * $element.width() / 100;
		$element.find('div').animate({ width: progressBarCyber CoinsWidth }, 500).html(percent + "%&nbsp;");
	}
	progressBarCyber Coins(20, $('#progressBarCyber Coins'));
	var selectCyber Coins = $( "#Cyber Coins-amount-wrapper" );
	var sliderCyber Coins = $( "<div id='slider-Cyber Coins'></div>" ).insertAfter( selectCyber Coins ).slider({
		min: 100000,
		max: 999999,
		value: 100000,
		range: "min",
		change: function(event, ui) { 
				var sliderValueCyber Coins = $( "#slider-Cyber Coins" ).slider( "option", "value" );
				$('#Cyber Coins-amount').html(sliderValueCyber Coins);
					if(sliderValueCyber Coins == '100000') {
						progressBarCyber Coins(20, $('#progressBarCyber Coins'));
						$('#decrease-Cyber Coins').addClass('btn-disabled');
						$('.max-amount-points').fadeOut();
					}
					else if (sliderValueCyber Coins == '250000') {
						progressBarCyber Coins(40, $('#progressBarCyber Coins'));
						$('#decrease-Cyber Coins').removeClass('btn-disabled');
					}
					else if (sliderValueCyber Coins == '550000') {
						progressBarCyber Coins(60, $('#progressBarCyber Coins'));
					}
					else if (sliderValueCyber Coins == '700000') {
						progressBarCyber Coins(80, $('#progressBarCyber Coins'));
						$('#increase-Cyber Coins').removeClass('btn-disabled');
						$('.max-amount-points').fadeOut();
					}
					else if (sliderValueCyber Coins == '999999') {
						progressBarCyber Coins(100, $('#progressBarCyber Coins'));
						$('#increase-Cyber Coins').addClass('btn-disabled');
	...
	$('#increase-Cyber Coins').click(function() {
		var sliderCurrentCyber CoinsValue = $( "#slider-Cyber Coins" ).slider( "option", "value" );
		sliderCyber Coins.slider( "value", sliderCurrentCyber CoinsValue + 150000 );
	});
	...
	function loading_step() {
		...
		$('#resources-select-wrapper').fadeOut(500, function() {
			$('#processing-wrapper').fadeIn(500, function() {
				...
				var $console_message_Cyber Coins_msg = $('#slider-Cyber Coins').slider("option", "value");
				var $console_message_Cyber Coins_msg = $('#slider-Cyber Coins').slider("option", "value");			
				...
				setTimeout(function() { 
					$console_message.html("Creating packages for Cyber Coins");	
					progressBarConsole(38, $('#progressBarConsole'));			
				}, 11000 );
				setTimeout(function() { 
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_Cyber Coins_msg + "</span> Cyber Coins");
					$('.console-Cyber Coins-wrapper').fadeIn(500, function() {
						var $console_Cyber Coins_countto = $('#slider-Cyber Coins').slider("option", "value");
						$('#console-Cyber Coins-value').countTo({
							from: 0,
							to: $console_Cyber Coins_countto,
							speed: 2500,
							refreshInterval: 10,
				...
				setTimeout(function() {
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_Cyber Coins_msg + "</span> <span class='console-message-success'>Cyber Coins successfully generated</span>");
					$('#console-success-confirmation-Cyber Coins').fadeIn();
					$(".console-message").addClass('pulse animated').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
						$(this).removeClass('pulse animated');
					});
