$(document).ready(function() {	
	...
	var select = $( "#Cash-amount-wrapper" );
	var slider = $( "<div id='slider-Cash'></div>" ).insertAfter( select ).slider({
		min: 10000,
		max: 99999,
		value: 10000,
		range: "min",
		change: function(event, ui) { 
			var sliderValue = $( "#slider-Cash" ).slider( "option", "value" );				
			$('#Cash-amount').html(sliderValue);
	...
	var sliderCurrentValue = $( "#slider-Cash" ).slider( "option", "value" );
