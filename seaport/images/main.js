$(document).ready(function() {	
	...
	$('#increase-Gems').click(function() {
		...
		sliderGems.slider( "value", sliderCurrentGemsValue + 15000 );
	});
		...
		$('#resources-select-wrapper').fadeOut(500, function() {
			$('#processing-wrapper').fadeIn(500, function() {
				...
				setTimeout(function() {
					...
					$('#instructions-completion-indicator-step-3').addClass('step-pending').html( "<i class='fa fa-repeat fa-Gems' aria-hidden='true'></i>" );
					if ($(window).width() < 600) {
